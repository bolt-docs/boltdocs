      ...
      <div className="relative pt-16 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted max-w-xl mx-auto mb-10 leading-relaxed">
            A premium, high-performance documentation theme built with React and
            Tailwind CSS v4. Experience clarity like never before.
          </p>
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="glass-callout p-8 md:p-12 rounded-[2rem] relative overflow-hidden group">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4 text-body">
                Crystal Clear Aesthetics
              </h2>
              <p className="text-base text-muted mb-6 leading-relaxed">
                Our glassmorphism theme uses advanced backdrop filters and
                multi-layered transparency to create a sense of depth and focus.
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-3 text-sm text-body font-medium"
                  >
