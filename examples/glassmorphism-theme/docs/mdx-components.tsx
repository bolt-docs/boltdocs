...
const components = {
  h1: (props: any) => (
    <h1 {...props} className="text-4xl font-black mb-6 custom-heading tracking-tighter" />
  ),
  h2: (props: any) => (
    <h2 {...props} className="text-2xl font-bold mt-12 mb-4 text-white/90 border-b border-white/5 pb-2" />
  ),
  p: (props: any) => (
