...
import { generateRoutes, invalidateRouteCache } from '../packages/core/dist/node/index.mjs';
...
async function main() {
  ...
  console.log('==================================================');
  console.log('File Count | JS Parser  | WASM Parser | Native Parser | Speedup (Native vs JS)');
  console.log('-----------|------------|-------------|---------------|-----------------------');
