...
export const Typographics = {
    ...
    p: ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
        <p className={cn('text-paragraph leading-relaxed my-5', className)} {...props} />
    ),
    ...
    mark: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
        <mark className={cn('bg-primary-500/10 text-primary-500 font-semibold px-1.5 py-0.5 rounded-md', className)} {...props} />
    ),
    blockquote: ({ className, ...props }: React.HTMLAttributes<HTMLQuoteElement>) => (
        <blockquote className={cn('border-l-4 border-primary-500 bg-soft/30 pl-4 py-2 my-6 italic text-muted rounded-r-lg', className)} {...props} />
    ),
    hr: ({ className, ...props }: React.HTMLAttributes<HTMLHRElement>) => (
        <hr className={cn('my-8 border-t border-subtle', className)} {...props} />
    ),
    ul: ({ className, ...props }: React.HTMLAttributes<HTMLUListElement>) => (
        <ul className={cn('list-disc pl-6 my-5 space-y-2 text-paragraph', className)} {...props} />
    ),
    ol: ({ className, ...props }: React.HTMLAttributes<HTMLOListElement>) => (
        <ol className={cn('list-decimal pl-6 my-5 space-y-2 text-paragraph', className)} {...props} />
    ),
