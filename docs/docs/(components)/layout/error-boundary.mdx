...
It's backed by [`react-error-boundary`](https://github.com/bvaughn/react-error-boundary) under the hood — you get the API a hundred tutorials already document, plus Boltdocs' default `ErrorBoundaryFallback` that already looks reasonable.
