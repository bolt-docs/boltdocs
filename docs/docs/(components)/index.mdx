...
Every piece on the right side of the diagram is itself a tiny component. If you don't like our defaults, swap any of them in your [`layout.tsx`](/docs/guides/advanced/custom-layout).
...
- **Custom layout** — see [Custom Layouts](/docs/guides/advanced/custom-layout) when you're ready to stop using the default `DocsLayout` and assemble your own.
