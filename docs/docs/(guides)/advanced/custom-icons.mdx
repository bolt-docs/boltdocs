...
title: Custom Icons
sidebarPosition: 9
description: Use Lucide icons or raw SVG strings throughout Boltdocs — tabs, sidebar, cards, and custom components.
---
...
- **Tabs** — `theme.tabs[].icon`
- **Sidebar groups** — `theme.sidebarGroups[].icon` or `meta.json.icon`
- **Cards** — `<Card icon="...">`
