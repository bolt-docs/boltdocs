...
import { BarChart, Tag, Globe, Search, GitBranch, Bot, FolderOpen } from 'lucide-react'
...
<Cards cols={3}>
  ...
  <Card title="Collections" icon={<FolderOpen />} href="/docs/integrations/collections">
    Group documents into blogs, updates, or tutorials with custom views.
  </Card>
</Cards>
