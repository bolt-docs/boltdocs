...
sidebarPosition: 2
description: Aprende a configurar el sistema de retroalimentación nativo y ligero de GitHub para recopilar sugerencias a nivel de página y de bloque de código.
badge: "New"
---
