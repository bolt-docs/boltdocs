...
| **`DocsLayout.Footer`** | `<footer>` | Envoltorio de sección inferior dentro del flujo de lectura (por ejemplo, para enlaces de navegación). | [`ComponentBaseProps`](#componentbaseprops-common) |
