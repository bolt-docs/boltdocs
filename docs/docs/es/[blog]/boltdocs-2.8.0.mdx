---
title: "Boltdocs 2.8.0 — Más rápido, más inteligente y realmente divertido de usar"
description: "División de código a nivel de ruta, presupuestos de rendimiento en doctor, tipos de ruta estrictos, Algolia DocSearch, API de plugins, plugin Mermaid optimizado y una salida de construcción más limpia"
date: 2026-05-27
cover: /blog-covers/Boltdocs-2.8.0.webp
author:
  name: Jesús Alcalá
  avatar: /avatar.jpeg
excerpt: "Boltdocs 2.8.0 trae división de código real, un doctor con presupuestos de rendimiento, tipado estricto de rutas, integración con Algolia DocSearch, una potente API de plugins, una estructura de `.boltdocs/` más limpia y Mermaid que no arrastra todo tu sitio."
---
...
2.8.0 es nuestro lanzamiento más grande hasta ahora. No porque hayamos añadido un montón de características llamativas — sino porque finalmente arreglamos lo que empieza a doler cuando tu documentación crece más allá de 50 páginas.
...
Como usamos la API REST directamente en lugar del paquete oficial `@docsearch/react`, el soporte de Algolia añade **cero bytes** a tu bundle del cliente hasta que lo configures.
