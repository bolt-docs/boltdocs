---
title: "Boltdocs 3.0.0 — Parser Nativo, Vercel Analytics, Giscus y una Reescritura Completa"
description: "Parser nativo impulsado por Zig, Vercel Analytics y Speed Insights, comentarios con Giscus, feedback personalizado, Ask AI renovado y docenas de mejoras"
date: 2026-06-22
cover: /blog-covers/Boltdocs-3.0.0.webp
author:
  name: Jesús Alcalá
  avatar: /avatar.jpeg
excerpt: "3.0.0 es el lanzamiento más grande hasta ahora — un parser nativo en Zig que es 5-6x más rápido, Vercel Analytics sin configuración, integración de comentarios con Giscus y docenas de mejoras en UI/UX y SEO."
---
