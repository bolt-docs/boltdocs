...
| **`seo`** | [`SeoConfig`](#seoconfig) | — | Controla la indexación, los metadatos Open Graph y los datos estructurados. |
| **`experimental`** | [`BoltdocsExperimentalConfig`](#experimentalconfig) | — | Habilita APIs opt-in que pueden evolucionar entre releases. |
