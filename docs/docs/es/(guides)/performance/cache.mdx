...
1. **Caché LRU en Memoria** — Caché rápido dentro del proceso para datos calientes
2. **Caché en Disco** — Persistido en el directorio `.boltdocs/` (organizado bajo `.boltdocs/cache/`, `.boltdocs/build/`, `.boltdocs/generated/`, `.boltdocs/reports/`) para reutilizar entre reinicios
3. **Invalidación** — Automática basada en mtime del archivo y hash de contenido
