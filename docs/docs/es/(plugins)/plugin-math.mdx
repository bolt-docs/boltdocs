...
Aquí hay matemáticas en línea: $E = mc^2$, y matemáticas en bloque:

$$
\sum_{k=1}^{\infty} \frac{1}{k^2} = \frac{\pi^2}{6}
$$

La fórmula cuadrática $x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}$ encuentra las raíces de $ax^2 + bx + c = 0$.
