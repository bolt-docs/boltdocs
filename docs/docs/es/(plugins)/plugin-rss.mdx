---
title: Generador de Feed RSS
sidebarPosition: 5
description: Genera feeds RSS y Atom a partir de tu documentación Boltdocs con soporte automático de i18n.
badge: "Nuevo"
---
...
- RSS: `https://mis-docs.com/feed.xml`
- Atom: `https://mis-docs.com/atom.xml`

Para sitios con i18n, cada idioma recibe su propio feed:

- `https://mis-docs.com/feed.xml` (idioma por defecto)
- `https://mis-docs.com/es/feed.xml` (español)
...
| :--- | :--- | :--- | :--- |
| **`limit`** | `number` | `20` | Número máximo de items por feed. Rango: 1–500. |
...
El plugin escribe archivos de feed en el directorio de salida de la compilación:

| Formato | Idioma por Defecto | Otros Idiomas |
| :--- | :--- | :--- |
| RSS | `/feed.xml` | `/{locale}/feed.xml` |
| Atom | `/atom.xml` | `/{locale}/atom.xml` |
