...
<Cards cols={2}>
  <Card title="PluginContext" icon={<Puzzle />} href="/docs/api/plugin-api">
    Base context object, base fields, and enriched namespaces overview.
  </Card>
  <Card title="Caches" icon={<Puzzle />} href="/docs/api/plugin-api/caches">
    Transform cache, routes cache, and in-memory FIFO cache.
  </Card>
  <Card title="Diagnostics" icon={<Puzzle />} href="/docs/api/plugin-api/diagnostics">
    Structured diagnostic reporting with severity levels.
  </Card>
  <Card title="Paths" icon={<Puzzle />} href="/docs/api/plugin-api/paths">
    Safe workspace path resolution with traversal protection.
  </Card>
  <Card title="Virtual Modules" icon={<Puzzle />} href="/docs/api/plugin-api/virtual-modules">
    Runtime virtual module declarations for Vite.
  </Card>
  <Card title="Slots" icon={<Puzzle />} href="/docs/api/plugin-api/slots">
    Declarative layout slot registration with 7 predefined positions.
  </Card>
  <Card title="Middleware" icon={<Puzzle />} href="/docs/api/plugin-api/middleware">
    Transform middleware pipeline (source, MDX, HTML).
  </Card>
  <Card title="Server" icon={<Puzzle />} href="/docs/api/plugin-api/server">
    HTTP middleware & server lifecycle hooks.
  </Card>
  <Card title="HMR" icon={<Puzzle />} href="/docs/api/plugin-api/hmr">
