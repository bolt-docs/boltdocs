...
The `PluginContext` object passed to every lifecycle hook carries eight
enriched namespaces that give plugins safe, typed access to the core's
internal machinery: **caches**, **diagnostics**, **paths**,
**virtual modules**, **slots**, **middleware**, **server**, and
**hmr**.
...
<Cards cols={2}>
  ...
  <Card title="Slots" href="/docs/api/plugin-api/slots">
    Declarative layout slot registration.
  </Card>
...
interface PluginContext {
  ...
  readonly slots: PluginSlotsAPI           // Register layout slots
...
| `slots` | [Slots](/docs/api/plugin-api/slots) | Register and query layout slot declarations. |
