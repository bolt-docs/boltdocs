...
* **Usage:** `boltdocs dev [root]` (or simply `boltdocs [root]`)
...
| **`outputFile`** | `string` | `".boltdocs/doctor-report.json"` | Path to write the diagnostic report file. |
