---
title: "Boltdocs 3.0.0 — Native Parser, Vercel Analytics, Giscus, and a Complete Rewrite"
description: "Zig-powered native parser, Vercel Analytics & Speed Insights, Giscus comments, custom feedback, Ask AI overhaul, and dozens of improvements"
date: 2026-06-22
cover: /blog-covers/Boltdocs-3.0.0.webp
author:
  name: Jesús Alcalá
  avatar: /avatar.jpeg
excerpt: "3.0.0 is the biggest release yet — a native Zig parser that's 5-6x faster, zero-config Vercel Analytics, Giscus comment integration and dozens of UI/UX and SEO improvements across the board."
tags: ["Release"]
---
