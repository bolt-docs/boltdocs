...
export const CTASection = () => {
  ...
  useGSAPScroll(contentRef, { animation: 'fade-up', delay: 0.2, duration: 0.8, intensity: 20 })
        ...
        <div ref={contentRef} className="max-w-3xl mx-auto text-center opacity-0">
          <div>
            ...
            <p className="text-base md:text-lg text-white/50 mb-10 max-w-xl mx-auto leading-relaxed font-medium">
              Create beautiful, performant documentation with zero config.
              Join thousands of developers already using Boltdocs.
            </p>
