      ...
      <main className="w-full max-w-[1400px] mx-auto px-6">
        <header className="flex flex-col justify-between py-12 mb-4">
          ...
          <p className="text-body/60">
            Here you can see what we are working on and what we plan to do in
            the future.
          </p>
        </header>
            ...
            return (
              <div key={statusKey} className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between px-1">
                  <div
                    className={`flex items-center gap-2 px-3 py-1.5 rounded-full bg-text-body/5 border border-text-body/10`}
                  >
                  ...
                  <span className="text-xs font-bold text-body/20 pr-1">
                    {features.length}
                  </span>
                </div>
