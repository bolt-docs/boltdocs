...
import { useLocalizedTo } from '../../packages/core/src/client/hooks/use-localized-to'
import { useConfig } from '../../packages/core/src/client/app/config-context'
import { useRoutes } from '../../packages/core/src/client/hooks/use-routes'

// Mock the dependencies of the hook
vi.mock('../../packages/core/src/client/app/config-context')
vi.mock('../../packages/core/src/client/hooks/use-routes')
...
describe('useLocalizedTo', () => {
  ...
  it('should handle i18n and versions if NOT a known route', () => {
    ;(useConfig as any).mockReturnValue({ 
      ...
      versions: { defaultVersion: 'v1', versions: [{ path: 'v1', label: 'v1' }] }
    })
    ;(useRoutes as any).mockReturnValue({ 
      currentLocale: 'es',
      currentVersion: 'v1',
